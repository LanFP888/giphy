...
function makeFavGifHTML(responseObj) {
  ...
  downloadBtn.attr("href", responseObj.data.images.fixed_width.url)
  ...
  var hr = $("<hr>")
  $(".favGif").prepend(gifDiv.append(gifRating, gifPreview, downloadBtn.prepend(downloadIcon), removeBtn, hr));
...
function rmFav() {
  var gifID = $(this).parent(".favGifObj").attr("data-gif-id")
  // console.log(gifID)
  //removes the whole div of the gif
  $(this).parent(".favGifObj").remove()
  //update the fav list
